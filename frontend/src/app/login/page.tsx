    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F3F4F6] dark:bg-gray-950 px-4 py-12 sm:px-6 lg:px-8 transition-colors duration-500">
      ...
      >
          ...
          <form className="px-8 pb-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    required
                    className="block w-full pl-11 pr-4 py-3.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600"
            ...
            <div className="text-center mt-6">
              <p className="text-gray-500 dark:text-gray-400 text-sm">
                ...
                <Link href="/signup" className="font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition-colors">
                  Create one for free
                </Link>
              </p>
            </div>
        ...
        <p className="mt-8 text-center text-gray-400 dark:text-gray-600 text-xs">
          &copy; 2026 TaskFlow. All rights reserved. Secure task management.
        </p>
      </motion.div>
    </div>
  );
